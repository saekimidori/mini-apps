...
function partyExcuse() {
  fetch('https://excuser.herokuapp.com/v1/excuse/party/')
    ...
    .then(data => {
      console.log(data)
      document.getElementById('partyExcuse').innerText = data[0].excuse
    })
    .catch(err => {
...
function familyExcuse() {
  fetch('https://excuser.herokuapp.com/v1/excuse/family/')
    ...
    .then(data => {
      console.log(data)
      document.getElementById('familyExcuse').innerText = data[0].excuse
    })
    .catch(err => {
        console.log(`error ${err}`)
    });
...
function childrenExcuse() {
  fetch('https://excuser.herokuapp.com/v1/excuse/children/')
    ...
    .then(data => {
      console.log(data)
      document.getElementById('childrenExcuse').innerText = data[0].excuse
    })
    .catch(err => {
        console.log(`error ${err}`)
    });
...
function collegeExcuse() {
  fetch('https://excuser.herokuapp.com/v1/excuse/college/')
    ...
    .then(data => {
      console.log(data)
      document.getElementById('collegeExcuse').innerText = data[0].excuse
    })
    .catch(err => {
        console.log(`error ${err}`)
    });
